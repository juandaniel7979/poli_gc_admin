...
import 'package:poli_gc_admin/forms/login_form_provider.dart';
import 'package:poli_gc_admin/screens/home_screen.dart';
import 'package:poli_gc_admin/services/auth_services.dart';
import 'package:poli_gc_admin/services/notifications_service.dart';
import 'package:poli_gc_admin/share_preferences/preferences.dart';
import 'package:poli_gc_admin/themes/app_theme.dart';
import 'package:poli_gc_admin/ui/input_decorations.dart';
import 'package:poli_gc_admin/widgets/auth_background.dart';
import 'package:poli_gc_admin/widgets/card_container.dart';
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              TextButton(
                onPressed: () {
                  // => Navigator.pushReplacementNamed(context, RegisterScreen.routerName)
                },
                style: ButtonStyle(
